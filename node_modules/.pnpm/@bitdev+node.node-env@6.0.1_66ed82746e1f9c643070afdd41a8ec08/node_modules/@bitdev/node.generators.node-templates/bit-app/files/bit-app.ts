...
export const bitAppFile = (context: ComponentContext) => {
  ...
  return {
    ...
    content: `import type { AppContext, Application, ApplicationInstance, AppDeployContext, AppBuildContext } from '@teambit/application';
import { run${namePascalCase} } from './${name}.js';
