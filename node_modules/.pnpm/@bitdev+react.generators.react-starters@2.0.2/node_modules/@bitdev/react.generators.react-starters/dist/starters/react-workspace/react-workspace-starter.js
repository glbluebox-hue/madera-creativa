...
class ReactWorkspaceStarter {
    constructor(name = 'react', description = 'React workspace with demo components', hidden = false, env) {
        this.name = name;
    ...
    static from(options = {}) {
        return () => new ReactWorkspaceStarter(options.name, options.description, options.hidden, options.env);
    }
}
