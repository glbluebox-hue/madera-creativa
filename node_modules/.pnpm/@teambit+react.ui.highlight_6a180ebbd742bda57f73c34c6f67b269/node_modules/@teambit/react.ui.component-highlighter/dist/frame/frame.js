...
export function Frame({ targetRef, watchMotion, className, stylesClass = styles.overlayBorder, style }) {
    ...
    const { x, y, strategy, reference, floating, update, refs, middlewareData } = useFloating({
        ...
        middleware: [
            ...
            size({
                ...
                apply({ elements, rects, availableHeight, availableWidth, middlewareData: applyMiddlewareData }) {
                    const shift = applyMiddlewareData[SHIFT_POSITIVE] || { x: 0, y: 0 };
    ...
    return (_jsx("div", { ref: floating, className: classnames(className, stylesClass, !isReady && styles.hidden), style: {
            ...style,
