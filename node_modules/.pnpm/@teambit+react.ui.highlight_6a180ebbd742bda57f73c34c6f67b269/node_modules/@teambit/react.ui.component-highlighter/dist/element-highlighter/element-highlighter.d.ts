...
import type { Placement } from '../label';
...
export declare function ElementHighlighter({ targetRef, components, placement, watchMotion, className, classes, ...props }: ElementHighlighterProps): import("react/jsx-runtime").JSX.Element;
