...
async function generateFiles(context, extraConfig, additionalEnvs, env) {
    return [
        {
            relativePath: 'workspace.jsonc',
            content: await (0, workspace_config_1.workspaceConfig)(context, extraConfig, additionalEnvs, env),
        },
        {
