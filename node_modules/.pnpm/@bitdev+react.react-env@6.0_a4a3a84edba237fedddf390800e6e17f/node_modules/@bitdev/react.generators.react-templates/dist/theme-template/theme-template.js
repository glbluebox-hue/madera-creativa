...
const dark_tokens_file_1 = require("./files/dark-tokens-file");
const theme_controller_file_1 = require("./files/theme-controller-file");
const theme_options_file_1 = require("./files/theme-options-file");
class ThemeTemplate {
    ...
    generateFiles(context) {
        return [
            ...
            (0, dark_tokens_file_1.darkTokensFile)(context),
            (0, theme_controller_file_1.themeControllerFile)(context),
            (0, theme_options_file_1.themeOptionsFile)(context),
        ];
    }
    static from(options = {}) {
