...
/**
 * ${context.namePascalCase} tokens theme.
 * Include all tokens in this object.
 */
export function ${context.nameCamelCase}Tokens() {
  const tokens = {
    /**
     * Color Palette
     */
 ...
 */
export type ${context.namePascalCase}Schema = ReturnType<typeof ${context.nameCamelCase}Tokens>;
`
  }
}
