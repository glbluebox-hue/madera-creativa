...
export default class BitId {
  ...
  getVersionPreReleaseData(): null | readonly string[] {
    ...
    // the actual type we get from semver is "null | ReadonlyArray<string | number>".
    // however, changing the type of this method, break many components that use it.
    return semver.prerelease(this.version) as null | readonly string[];
  }
