...
exports.PlatformFeatureStarter = void 0;
...
class PlatformFeatureStarter {
    constructor(name = 'platform-feature', description = 'Platform feature workspace with demo components', hidden = false, env) {
        this.name = name;
    ...
    generateFiles(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }, ['bitdev.react/react-env'], this.env);
        });
    }
    getAppId(context) {
    ...
    static from(options = {}) {
        return () => new PlatformFeatureStarter(options.name, options.description, options.hidden, options.env);
    }
}
exports.PlatformFeatureStarter = PlatformFeatureStarter;
//# sourceMappingURL=platform-feature-starter.js.map