...
export class ExpressAppTemplate implements ComponentTemplate {
  constructor(
    readonly name = 'express-server',
    readonly description = 'create a basic express server',
  ...
  static from(options: ExpressAppTemplateOptions = {}) {
    return () =>
      new ExpressAppTemplate(options.name, options.description, options.hidden, options.env);
  }
}
