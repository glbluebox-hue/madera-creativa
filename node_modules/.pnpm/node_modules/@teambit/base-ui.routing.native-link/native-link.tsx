 ...
 */
export function NativeLink({ href = '', external, replace, onClick, children, ...rest }: LinkProps) {
  ...
  const handleClick = useCallback(
    ...
    [href, replace, onClick, external]
  );

  // @ts-ignore TOOD: @Uri please check this
  return <a {...rest} {...externalProps} onClick={handleClick} href={href}>{children}</a>;
}
