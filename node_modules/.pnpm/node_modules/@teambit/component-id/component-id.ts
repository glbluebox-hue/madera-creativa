...
export class ComponentID {
  ...
  /**
   * important. the actual return type is "null | ReadonlyArray<string | number>".
   * we can't simply change it here because it will break many components that use this component.
   *
   * examples:
   * 1.0.0 => null
   * 1.0.0-dev.1 => ['dev', 1]
