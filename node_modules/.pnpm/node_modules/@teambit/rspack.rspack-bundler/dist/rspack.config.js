...
function generateHtmlPlugin(config) {
    ...
    return new core_1.rspack.HtmlRspackPlugin(filteredConfig);
}
...
function configFactory(target, context) {
    ...
    const compressionPlugin = compress ? new compression_webpack_plugin_1.default() : undefined;
    const splitChunks = target.chunking?.splitChunks;
    const outputPath = `${target.outputPath}${path_1.sep}public`;
    ...
    const config = {
        ...
        plugins: [
            ...
            new core_1.rspack.ProvidePlugin({
