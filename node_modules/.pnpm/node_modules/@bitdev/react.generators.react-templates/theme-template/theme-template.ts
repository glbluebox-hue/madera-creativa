...
import { darkTokensFile } from './files/dark-tokens-file';
import { themeControllerFile } from './files/theme-controller-file';
import { themeOptionsFile } from './files/theme-options-file';
...
export class ThemeTemplate implements ComponentTemplate {
  ...
  generateFiles(context: ComponentContext): ComponentFile[] {
    return [
      ...
      specFile(context),
      darkTokensFile(context),
      themeControllerFile(context),
      themeOptionsFile(context),
    ];
  }
