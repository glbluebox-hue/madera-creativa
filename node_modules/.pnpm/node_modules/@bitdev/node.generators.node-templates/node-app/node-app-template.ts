...
export class NodeAppTemplate implements ComponentTemplate {
  constructor(
    readonly name = 'node-app',
    readonly description = 'create a basic nodejs app.',
