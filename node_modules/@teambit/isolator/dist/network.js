...
class Network {
  constructor(_graphCapsules, seedersIds, _capsulesRootDir) {
    ...
    _defineProperty(this, "_originalSeeders", void 0);
  }
  ...
  async getCapsulesToCompile() {
    ...
    const capsules = await Promise.all(this.seedersCapsules.map(async seederCapsule => {
      ...
      const capsuleUsePreviouslySavedDists = await _capsuleList().default.capsuleUsePreviouslySavedDists(seederCapsule.component);
