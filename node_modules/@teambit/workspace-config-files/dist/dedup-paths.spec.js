...
const envCompsDirsMap = {
  'teambit.harmony/node': {
    ...
    paths: ['react/apps/react-app-types', 'compilation/babel-compiler', 'compilation/compiler-task', 'mdx/compilers/mdx-compiler', 'mdx/compilers/mdx-multi-compiler', 'compilation/compilers/multi-compiler', 'defender/eslint-linter', 'mdx/generator/mdx-starters', 'mdx/generator/mdx-templates', 'react/generator/react-starters', 'react/generator/react-templates', 'defender/jest-tester', 'react/jest/react-jest', 'defender/linter-task', 'defender/mocha-tester', 'compilation/modules/babel-file-transpiler', 'defender/prettier-formatter', 'preview/react-preview', 'defender/tester-task', 'typescript/typescript-compiler', 'webpack/webpack-bundler', 'webpack/webpack-dev-server', 'react/webpack/react-webpack']
  },
  ...
  'teambit.envs/env': {
    id: 'teambit.envs/env',
    paths: ['react/examples/my-react-env', 'mdx/mdx-env', 'node/node', 'node/node-env-extension', 'react/react-env', 'react/react-env-extension']
  },
  ...
  '00330a9c547353867d519c34f47e17ddc9f161d1': {
    extendingConfigFile: {
      ...
      extendingTarget: {
        ...
        filePath: '/Users/giladshoham/dev/temp/new-react-18-config-files/node_modules/.cache/tsconfig.bit.17b99a1071b1d2d86ed04ebce68903b82403f278.json'
      },
  ...
  '3c5960bcad98570b98834a5c37f47dd4729dbef0': {
    extendingConfigFile: {
      ...
      extendingTarget: {
        ...
        filePath: '/Users/giladshoham/dev/temp/new-react-18-config-files/node_modules/.cache/tsconfig.bit.dab521d0914afe64de248743e05a169cf9b4b50c.json'
      },
...
const eslintExtendingConfigFilesMap = {
  '8810839e74a9c41694bb5a2a8587dcae71dc389d': {
    extendingConfigFile: {
      ...
      extendingTarget: {
        ...
        filePath: '/Users/giladshoham/dev/temp/new-react-18-config-files/node_modules/.cache/.eslintrc.bit.be8facfbdcf1db685d5020f8612d8c2c3ac2eb7c.json'
      },
  ...
  ff6ea265e6f21ce25f7985570beef37dd957d0dc: {
    extendingConfigFile: {
      ...
      extendingTarget: {
        ...
        filePath: '/Users/giladshoham/dev/temp/new-react-18-config-files/node_modules/.cache/.eslintrc.bit.e5ca5528c64e0442b05b949fea42cdda4243d840.json'
      },
  ...
  '91021f2c973a2940c70b75447639e4ea2a799955': {
    extendingConfigFile: {
      ...
      extendingTarget: {
        ...
        filePath: '/Users/giladshoham/dev/temp/new-react-18-config-files/node_modules/.cache/.eslintrc.bit.7f229bf5ab41e8bfe61916de6c68f9c14c76f23e.json'
      },
  ...
  f1743b227e588db0c59d4a43171653e6c4262816: {
    extendingConfigFile: {
      ...
      extendingTarget: {
        ...
        filePath: '/Users/giladshoham/dev/temp/new-react-18-config-files/node_modules/.cache/.eslintrc.bit.c503f7386e2a637d91c74f7df90d8fafe79c4378.json'
      },
...
const eslintExpectedDedupedPaths = [{
...
const prettierExtendingConfigFilesMap = {
  '082f546b2555ea89e7063b20de47c039d387fc74': {
    extendingConfigFile: {
      ...
      extendingTarget: {
        ...
        filePath: '/Users/giladshoham/dev/temp/new-react-18-config-files/node_modules/.cache/.prettierrc.bit.e4882af8861bcf5b0147891d8b70b40a10428881.cjs'
      },
      hash: '082f546b2555ea89e7063b20de47c039d387fc74'
    },
    envIds: ['teambit.harmony/node', 'teambit.react/react-env@0.0.44', 'teambit.react/react', 'teambit.envs/env', 'teambit.mdx/mdx-env@0.0.6', 'teambit.node/node@0.0.16', 'teambit.react/examples/my-react-env@0.0.39']
  }
};
const prettierExpectedDedupedPaths = [{
  ...
  describe('dedupePaths', () => {
    describe('ts example', () => {
      ...
      it('should reduce files to minimum necessary', async () => {
        (0, _chai().expect)(result).to.have.lengthOf(tsExpectedDedupedPaths.length);
      });
      it('should place files in correct folders', async () => {
        (0, _chai().expect)(result).to.deep.equal(tsExpectedDedupedPaths);
      });
    });
    describe('eslint example', () => {
      ...
      it('should reduce files to minimum necessary', async () => {
        (0, _chai().expect)(result).to.have.lengthOf(eslintExpectedDedupedPaths.length);
      });
      it('should place files in correct folders', async () => {
        (0, _chai().expect)(result).to.deep.equal(eslintExpectedDedupedPaths);
      });
    });
    describe('prettier example', () => {
      ...
      it('should reduce files to minimum necessary', async () => {
        (0, _chai().expect)(result).to.have.lengthOf(prettierExpectedDedupedPaths.length);
      });
      it('should place files in correct folders', async () => {
        (0, _chai().expect)(result).to.deep.equal(prettierExpectedDedupedPaths);
      });
    });
    describe('empty component paths', () => {
      it('should return empty array when envCompsDirsMap has no paths for the envIds', () => {
        ...
        const result = (0, _dedupPaths().dedupePaths)(configMap, emptyEnvCompsDirsMap, undefined);
...
//# sourceMappingURL=dedup-paths.spec.js.map