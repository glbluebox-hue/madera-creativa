...
class ScopeUI {
  ...
  contextSlot, drawerWidgetSlot, drawerComponentsFiltersSlot) {
    ...
    _defineProperty(this, "setSidebarToggle", () => {});
    _defineProperty(this, "registerMenuRoutes", routes => {
      this.menuSlot.register(routes);
      return this;
    });
    _defineProperty(this, "componentUrlFunc", void 0);
     ...
     */
    _defineProperty(this, "registerSidebarWidget", componentTreeNodes => {
     ...
     */
    _defineProperty(this, "registerSidebarLink", (...links) => {
      this.sidebarItemSlot.register(links);
    });
    _defineProperty(this, "registerDrawers", (...drawer) => {
     ...
     */
    _defineProperty(this, "registerDrawerComponentFilters", filters => {
      this.drawerComponentsFiltersSlot.register(filters);
    });
    _defineProperty(this, "registerDrawerWidgets", widgets => {
  ...
  getContext(componentUrlFn) {
    ...
    _react().default.createElement(_componentModules().ComponentUrlProvider, {
      value: componentUrlFn || this.componentUrlFunc
    }, children);
...
_defineProperty(ScopeUI, "dependencies", [_ui().UIAspect, _component().ComponentAspect, _sidebar().SidebarAspect, _commandBar().CommandBarAspect]);
_defineProperty(ScopeUI, "runtime", _ui().UIRuntime);
_defineProperty(ScopeUI, "slots", [_harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType(), _harmony().Slot.withType()]);
_defineProperty(ScopeUI, "defaultConfig", {
  showGallery: true
});
var _default = exports.default = ScopeUI;
