import { type ProjectRootDir, type DependencyManifest, type PkgResolutionId, type PinnedVersion, type PackageVersionPolicy, type TrustPolicy } from '@pnpm/types';
...
export type AtomicResolution = TarballResolution | DirectoryResolution | GitResolution | BinaryResolution;
