 ...
 */
function formatSourceValue(value, indent = '  ') {
    var _a;
    ...
    const closers = { '{': '}', '[': ']', '(': ')' };
    if (!closers[open] || closers[open] !== close)
        return value;
    ...
    for (let i = 0; i < inner.length; i++) {
        ...
        if (strChar) {
            buf += ch;
            if (ch === '\\') {
                buf += (_a = inner[i + 1]) !== null && _a !== void 0 ? _a : '';
                i += 1;
                continue;
            }
            if (ch === strChar)
...
//# sourceMappingURL=format-source-value.js.map