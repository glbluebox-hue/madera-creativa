...
_defineProperty(WorkspaceUI, "dependencies", [_ui().UIAspect, _component().ComponentAspect, _sidebar().SidebarAspect, _componentTree().ComponentTreeAspect, _commandBar().CommandBarAspect, _graph().GraphAspect]);
