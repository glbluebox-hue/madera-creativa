...
export const TabInner = forwardRef<HTMLDivElement, TabInnerProps>(
  ({ selectedTab, enableAnimation = false, className, ...rest }: TabInnerProps, ref) => {
    ...
    return (
      <div
        className={classNames(styles.tabInner, styles.innerStyle, className)}
        style={borderStyles}
        ref={ref}
        {...rest}
      />
