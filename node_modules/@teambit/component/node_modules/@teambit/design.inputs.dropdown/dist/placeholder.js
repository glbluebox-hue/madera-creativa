...
export function Placeholder(_a) {
    var { dropdownIcon, children, className } = _a, rest = __rest(_a, ["dropdownIcon", "children", "className"]);
    return (React.createElement(MenuItem, Object.assign({ className: classNames(styles.dropdownPlaceholder, className) }, rest),
        children,
        " ",
        dropdownIcon || React.createElement(FatArrowDown, null)));
}
