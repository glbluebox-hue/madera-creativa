...
process.emit = function (name, data) {
  ...
  name === `warning` && typeof data === `object` && (data.name === `DeprecationWarning` && data.message.includes(`punycode`) || data.code === `DEP0040`) || data.name === `DeprecationWarning` && data.message.includes(`util._extend`) || data.code === `DEP0060`) return false;
