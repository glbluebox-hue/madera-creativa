...
function Card(_a) {
    ...
    return (react_1.default.createElement("div", Object.assign({ "data-bit-id": "teambit.base-ui/surfaces/card", className: (0, classnames_1.default)(card_module_scss_1.default.card, base_ui_surfaces_background_1.backgrounds.layer, base_ui_css_components_elevation_1.elevationClass[elevation], base_ui_css_components_roundness_1.roundnessClass[roundness], className) }, rest)));
}
exports.Card = Card;
Card.defaultProps = {
    elevation: 'low',
