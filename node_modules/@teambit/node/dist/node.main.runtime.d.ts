...
import type { ReactMain, UseTypescriptModifiers } from '@teambit/react';
...
export declare class NodeMain {
     ...
     */
    useWebpack: (modifiers?: import("@teambit/react").UseWebpackModifiers) => EnvTransformer;
    /**
     * An API to mutate the prettier config
     */
    usePrettier: (modifiers?: import("@teambit/react/react.main.runtime").UsePrettierModifiers) => EnvTransformer;
    /**
     * An API to mutate the eslint config
     */
    useEslint: (modifiers?: import("@teambit/react/react.main.runtime").UseEslintModifiers) => EnvTransformer;
    /**
    ...
    static provider([loggerAspect, envs, application, react, generator, tsAspect, workerMain]: [
        LoggerMain,
        EnvsMain,
        ApplicationMain,
        ReactMain,
        ...
        TypescriptMain,
        WorkerMain
    ], config: any, slots: any, harmony: Harmony): Promise<NodeMain>;
}
