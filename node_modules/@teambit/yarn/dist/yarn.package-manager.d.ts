import type { InstallationContext, DependencyResolverMain, PackageManager, PackageManagerInstallOptions, PackageManagerResolveRemoteVersionOptions, ResolvedPackageVersion } from '@teambit/dependency-resolver';
...
export declare class YarnPackageManager implements PackageManager {
    ...
    install({ rootDir, manifests, componentDirectoryMap }: InstallationContext, installOptions?: PackageManagerInstallOptions): Promise<{
