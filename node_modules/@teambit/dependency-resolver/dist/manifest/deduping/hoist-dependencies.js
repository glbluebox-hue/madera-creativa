 ...
 */
function hoistDependencies(depIdIndex, options) {
...
function findMostCommonVersion(versions) {
  ...
  (0, _lodash().forEach)(counts, (count, version) => {
    if (count > result.count || count === result.count && _semver().default.gt(version, result.version)) {
