...
export const TEXTOS: Record<Idioma, Textos> = {
  es: {
    ...
    herramientas: {
      selection: 'Seleccionar', freedraw: 'Lápiz', line: 'Línea', arrow: 'Flecha',
      text: 'Texto', eraser: 'Goma', cota: 'Cota',
    },
  ...
  en: {
    ...
    herramientas: {
      selection: 'Select', freedraw: 'Pencil', line: 'Line', arrow: 'Arrow',
      text: 'Text', eraser: 'Eraser', cota: 'Dimension',
    },
  ...
  it: {
    ...
    herramientas: {
      selection: 'Seleziona', freedraw: 'Matita', line: 'Linea', arrow: 'Freccia',
      text: 'Testo', eraser: 'Gomma', cota: 'Quota',
    },
